...
def main():
    ...
    meta={'selected':selected,'summary':summary.to_dict('records'),'windows':results,
      ...
      'promotion_scope_audit':promotion_audit,'catalog_price_varies':False,'scope':'commandes confirmees','causal':False,'automatic_application_allowed':False,'human_validation_required':True,'margin_floor':FLOOR}
